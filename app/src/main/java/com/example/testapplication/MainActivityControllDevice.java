        ...
        servoRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    btnLight.setClickable(Boolean.parseBoolean(snapshot.getData().get("manual").toString()));
                    btnPump.setClickable(Boolean.parseBoolean(snapshot.getData().get("manual").toString()));
                    btnServo.setClickable(Boolean.parseBoolean(snapshot.getData().get("manual").toString()));
